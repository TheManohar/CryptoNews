    ...
    dbc.Row([
        dbc.Col([
            html.Div([
                html.H1('CryptoNews'),
                dcc.Markdown('''
                    An interactive dashboard by [Manohar Sitapati](https://www.linkedin.com/in/manoharsitapati/).
                    Detailed documentation and code are available on [GitHub](https://github.com/TheManohar/CryptoNews#readme).
                            ''')
            ], style={'padding':10}),
            html.Div([
